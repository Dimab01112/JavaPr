package org.example; // Ensure this package declaration matches the actual package location

import java.util.ArrayList;
import java.util.List;
import org.example.Product; // Import Product class
import org.example.Cart; // Import Cart class
